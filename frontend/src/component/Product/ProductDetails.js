...
const ProductDetails = ({match}) => {
    ...
    useEffect(() => {
      ...
      dispatch(getProductDetails(match.params.id));   //in backened we use req.params.id
...
if(product.Stock<=quantity){
 ...
 <Fragment>
    {loading?(<Loader />):(  <Fragment>
        <MetaData title={`${product.name} --HOMEEASY`} />
        <div className="list">
       ...
       {/* <div>{product}</div> */}
         <div>
            <Carousel>
               ...
               <img 
                ...
                key={i} //imp. to mention key while using map
                 src={item.url}
                 alt={`${i}slide`}
               />
                ))}
        ...
        <div>
            ...
            <div className="detailsBlock-3">
                ...
                <h3 className="homeHeading">REVIEWS</h3>
