...
dispatch(getAllReviews(productId));
  ...
  const columns=[
    ...
    {
      field:"name",headerName:"Name",minWidth:200,flex:0.6,
    },
    {
        field:"comment",headerName:"Comment", minWidth:350,flex:0.6
      },
    {
      field:"rating",headerName:"Rating",type:"number",minWidth:270,flex:0.4,
      cellClassName:(params)=>{return params.getValue(params.id,"rating")>=3?
      "greenColor":"redColor"
  },
    },
    {
      field:"actions", flex:0.3, headerName:"Actions",
